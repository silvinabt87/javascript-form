...
form.addEventListener("submit", function (e) {
  ...
  var edad = document.createElement("li");
  var email = document.createElement("li");
  var comentario = document.createElement("li");
  var borrar = document.createElement("button"); // asignar clases para darle estilo al div que se genera
  ...
  body.appendChild(div);
  form.reset(); //   validar el campo "nombre"

  var validarNombre = nombre.innerText;
  var letras = true;

  for (var i = 0; i < validarNombre.length; i++) {
    var letra = validarNombre[i];
    ...
    if (letras == true) {
      var mostrarValidezNombre = document.createElement("p");
      var tituloCampoEdad = document.getElementById("tituloCampoEdad");
      ...
      var _mostrarValidezNombre = document.createElement("p");

      var _tituloCampoEdad = document.getElementById("tituloCampoEdad");

      form.appendChild(_mostrarValidezNombre);
      form.insertBefore(_mostrarValidezNombre, _tituloCampoEdad);
      _mostrarValidezNombre = "Alguno de los caracteres que ingresaste es inválido. Recordá ingresar solo letras";
    }
